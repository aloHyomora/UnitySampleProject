...
namespace _016_Mission           //015_MISSION1 함수 입력 부분 처리하기
{                                //callbyreference 왜 필요한지
    internal class Program
    {
        ...
        static void InputMehod(ref int num1,ref int num2, out char op)     // out char op 로 하면 밑에서 char op='' 처럼 초기화 안해도 됨.
        {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                InputMehod(ref num1, ref num2, out op);
